...
### Windows 本機部署與 Cloudflare Tunnel 教學

`Anaconda` · `Python 3.12` · `NVIDIA GPU` · `MuseTalk`

[開始安裝](#只需要完成-6-步)　[本機啟動](#6-啟動本機-live-ai)　[Cloudflare 公開](#9-cloudflare-tunnel-測試)　[故障排除](#10-常見問題)

</div>

![Windows](https://img.shields.io/badge/Windows-10%2F11-0078D4?logo=windows&logoColor=white) ![Python](https://img.shields.io/badge/Python-3.12-3776AB?logo=python&logoColor=white) ![GPU](https://img.shields.io/badge/NVIDIA-CUDA-76B900?logo=nvidia&logoColor=white) ![License](https://img.shields.io/badge/用途-NTHU%20Live%20AI-0E7490)

> **閱讀方式**：先完成「只需要完成 6 步」，再看進階模型與 Cloudflare。每個程式碼區塊都可以直接複製，每個網址都可以直接點擊。

![NTHU Live AI 系統架構與使用流程](system-architecture.png)
...
|---|---|
| 安裝必要軟體 | [環境需求](#1-環境需求) |
| 建立 Python 環境 | [建立 Anaconda 環境](#3-建立-anaconda-環境) |
| 啟動網站 | [啟動本機 Live AI](#6-啟動本機-live-ai) |
| 確認 GPU | [GPU 檢查](#確認-gpu-可被-pytorch-使用) |
| 公開測試 | [Cloudflare Tunnel](#9-cloudflare-tunnel-測試) |
| 發布本教學頁 | [GitHub Pages](#github-pages-發布方式) |
...
5. 等待 Actions 完成後，GitHub 會提供教學網址。

Cloudflare 官方下載頁：[Windows cloudflared](https://developers.cloudflare.com/cloudflare-one/networks/connectors/cloudflare-tunnel/downloads/#windows)

Anaconda 官方下載頁：[Anaconda](https://www.anaconda.com/download)

NVIDIA 驅動下載頁：[NVIDIA Driver](https://www.nvidia.com/Download/index.aspx)
...
> [!IMPORTANT]
> Quick Tunnel 只適合短期測試。要讓外部使用者完整使用 Live AI，前端與後端都必須有可連線的 HTTPS 位址。
